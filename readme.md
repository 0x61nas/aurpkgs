...
| `smolvm` | Tool to build & run portable, lightweight, self-contained virtual machines. | 1.0.3-1 | x86_64,aarch64 |
| `smolvm-bin` | Tool to build & run portable, lightweight, self-contained virtual machines. | 1.0.3-1 | x86_64 |
