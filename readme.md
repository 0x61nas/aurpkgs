...
| `autolock` | A minimal X11 idle-watcher | 0.3-1 | x86_64,aarch64 |
| `autolock-git` | A minimal X11 idle-watcher | 0.3.r2.g68f70aa-1 | x86_64,aarch64 |
...
| `git-guitar-bin` | A terminal based git client with fast topological & chronological graph rendering - Pre-Build binary | 0.2.5-1 | x86_64 |
