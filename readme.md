...
| `archy-dwm-git` | A dynamic window manager for X with some patches applied | 1.0.0.r38.g4d8386d-1 | i686,x86_64 |
...
| `dehub-git` | A TUI to de-GitHub yourself. Control PRs, Actions, Issues, Notifications. | r671.5f4b2f8-1 | x86_64,aarch64,riscv64 |
...
| `flyline-bin` | Bash plugin to replace readline for a modern line editing experience: syntax highlighting, agent integration, rich prompts, tooltips, fuzzy history search, and more | 1.7.1-1 | x86_64,aarch64,riscv64,armv7 |
...
| `gitpane` | Multi-repo Git workspace dashboard for the terminal | 0.9.1-1 | x86_64,aarch64,riscv64 |
...
| `o2-rs` | Rust port of the ORCΛ esoteric programming language and terminal livecoding environment | 0.3.5-1 | x86_64,aarch64,riscv64 |
| `o2-rs-bin` | Rust port of the ORCΛ esoteric programming language and terminal livecoding environment | 0.3.5-1 | x86_64,aarch64 |
...
| `patent` | A prior-art search for your code ideas. Stop building what already exists. | 0.9.0-1 | x86_64,aarch64,riscv64 |
...
| `scriptor` | Local speech-to-text CLI & TUI. | 1.1.0-1 | x86_64,aarch64 |
