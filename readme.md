...
| `gitpane` | Multi-repo Git workspace dashboard for the terminal | 0.8.1-1 | x86_64,aarch64,riscv64 |
...
| `smolvm` | Tool to build & run portable, lightweight, self-contained virtual machines. | 1.3.2-1 | x86_64,aarch64,riscv64 |
| `smolvm-bin` | Tool to build & run portable, lightweight, self-contained virtual machines. | 1.3.2-1 | x86_64 |
