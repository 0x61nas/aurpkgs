...
| `autolock` | A minimal X11 idle-watcher | 0.3-2 | x86_64,aarch64 |
| `autolock-git` | A minimal X11 idle-watcher | 0.3.r2.g68f70aa-2 | x86_64,aarch64 |
...
| `gitpane` | Multi-repo Git workspace dashboard for the terminal | 0.7.15-1 | x86_64,aarch64,riscv64 |
| `gitpane-bin` | Multi-repo Git workspace dashboard for the terminal | 0.7.15-1 | x86_64,aarch64 |
...
| `smolvm` | Tool to build & run portable, lightweight, self-contained virtual machines. | 1.1.1-1 | x86_64,aarch64,riscv64 |
| `smolvm-bin` | Tool to build & run portable, lightweight, self-contained virtual machines. | 1.1.1-1 | x86_64 |
