...
| `flyline-bin` | Bash plugin to replace readline for a modern line editing experience: syntax highlighting, agent integration, rich prompts, tooltips, fuzzy history search, and more | 1.2.6-1 | x86_64,aarch64,riscv64,armv7 |
...
| `smolvm` | Tool to build & run portable, lightweight, self-contained virtual machines. | 1.4.7-1 | x86_64,aarch64,riscv64 |
| `smolvm-bin` | Tool to build & run portable, lightweight, self-contained virtual machines. | 1.4.7-1 | x86_64 |
