...
| `git-guitar` | A terminal based git client with fast topological & chronological graph rendering | 0.2.4-1 | x86_64,aarch64 |
| `git-guitar-bin` | A terminal based git client with fast topological & chronological graph rendering - Pre-Build binary | 0.2.4-1 | x86_64 |
...
| `smolvm` | Tool to build & run portable, lightweight, self-contained virtual machines. | 1.0.4-1 | x86_64,aarch64 |
| `smolvm-bin` | Tool to build & run portable, lightweight, self-contained virtual machines. | 1.0.4-1 | x86_64 |
...
| `tuxedo` | A fast, keyboard-driven terminal UI for todo.txt. | 2026.6.2-1 | x86_64,aarch64 |
